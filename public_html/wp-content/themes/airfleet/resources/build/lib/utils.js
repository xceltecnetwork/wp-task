...
module.exports.tests = {
  ...
  images: /(resources[\\/]images|node_modules)[\\/].*\.(ico|jpg|jpeg|png|svg|gif)$/,
...
module.exports.getUserConfigFilename = () => {
  const files = [
    'config-local.json',
    'config.json',
  ];
...
module.exports.getUserConfig = () => {
  var userConfigPath = path.join(process.cwd(), module.exports.getUserConfigFilename());

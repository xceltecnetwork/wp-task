...
return [
	...
	'providers'           => [
		...
		\App\Core\RegisterDirectivesServiceProvider::class,
		\App\Core\RegisterComponentsServiceProvider::class,
		\App\Core\RegisterBlocksServiceProvider::class,
		\App\Core\OptionsServiceProvider::class,
		\App\Core\GoogleTagManagerServiceProvider::class,
		\App\Core\AllowJsonUploadsServiceProvider::class,
		\App\Core\GoogleMapsServiceProvider::class,
		\App\Core\HideThemeEditorServiceProvider::class,
		\App\Core\HubSpotServiceProvider::class,
		\App\Core\FormsServiceProvider::class,
		\App\Core\CF7ServiceProvider::class,
		\App\Core\AdminSearchCustomFieldsServiceProvider::class,
	],
